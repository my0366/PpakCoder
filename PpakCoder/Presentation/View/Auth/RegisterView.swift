...
class RegisterView : UIViewController {
    ...
    @IBAction func registerButtonTapped(_ sender: Any) {
        ...
        if let password = passwordTextField.text, let name = nameTextField.text {
            UserViewModel.shared.register(name: name, email: email, password: password) { res in
...
extension RegisterView : UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
